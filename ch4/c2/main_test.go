...
func Test(t *testing.T) {
	tests := []struct {
		...
		{"Dhalinar", TypeStandard, "I will take responsibility for what I have done. If I must fall, I will rise each time a better man.", "I will take responsibility for what I have done. If I must fall, I will rise each time a better man.", true},
	}
	if withSubmit {
		submitCases := []struct {
			name           string
